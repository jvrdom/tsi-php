...
CREATE TABLE `cliente_consulta` (
  ...
  KEY `fk_cliente_has_consulta_consulta1_idx` (`consulta_id_consulta`),
  ...
  CONSTRAINT `fk_cliente_has_consulta_consulta1` FOREIGN KEY (`consulta_id_consulta`) REFERENCES `consulta` (`id_consulta`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `user_calendario`
--

DROP TABLE IF EXISTS `user_calendario`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_calendario` (
  `user_id_usuario` int(11) NOT NULL,
  `calendario_id_calendario` int(11) NOT NULL,
...
--
-- Dumping data for table `user_calendario`
--

LOCK TABLES `user_calendario` WRITE;
/*!40000 ALTER TABLE `user_calendario` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_calendario` ENABLE KEYS */;
UNLOCK TABLES;
